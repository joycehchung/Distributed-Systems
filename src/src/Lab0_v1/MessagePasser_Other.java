...
public class MessagePasser_Other {
	...
	public MessagePasser_Other(String configuration_filename, String local_name, 
  ...
  public static void main(String[] args) {
		...
		// MessagePasser_Other instance #2 (Node Bob) connecting to instance #1 (Node Alice)
		...
		new MessagePasser_Other(arg0, arg1, nameB, ipB, portB, nodes, nameA, ipA, portA, 1);
