...
public class MessagePasser {
    ...
    public static String[] allNodes = new String[4];
    ...
    public void send(final TimeStampedMessage theMessage) {
        ...
        if (sendRule == DROP) {
        	...
        	// Add message to send queue (duplicate flag set to false)
        	DoSend(theMessage);
        	// Add second version of message to send queue (duplicate flag set to true)
